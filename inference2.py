...
class GeoFormer():
    ...
    def resample_kpts(self, kpts: np.ndarray, height_ratio, width_ratio):
        kpts[:, 0] *= width_ratio
        kpts[:, 1] *= height_ratio
    ...
    def match_pairs2(self, im1_path, im2_path, cpu=False, is_draw=False):
        ...
        kpts1 = self.resample_kpts(kpts1, sc1[1], sc1[0])
        kpts2 = self.resample_kpts(kpts2, sc1[1], sc1[0])
...
def get_args():
    ...
    parser.add_argument("--NMS", default=True, action='store_true')
...
g.match_pairs2('/data/lyh/code/CasMTR/assets/demo_imgs/london_bridge_19481797_2295892421.jpg', '/data/lyh/code/CasMTR/assets/demo_imgs/london_bridge_49190386_5209386933.jpg', is_draw=True)
