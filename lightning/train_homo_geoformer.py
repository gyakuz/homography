...
def main():
    ...
    args.gpus = 4  # 或者使用 setup_gpus 函数来自动设置
    gpus = "4,5,6,7"
    ...
    model = PL_H_GeoFormer(default_config, profiler=profiler, pretrained_ckpt=None, log_dir=logger.log_dir)
    ...
    trainer = pl.Trainer(
        ...
        enable_progress_bar=True,  # 根据你的喜好启用或禁用进度条
